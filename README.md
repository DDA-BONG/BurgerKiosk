...
## 4단계 코드의 실행 스크린샷
![4단계 실행화면](img/subject4-1.png)
![4단계 실행화면2](img/subject4-2.png)
  - 선택한 후 취소 한 경우
- 구현한 내용 (위 그림 참조)
  - 선택할 때 마다 ListBox에 선택한 메뉴와 옵션이 추가되고, 취소할 때마다 해당 항목이 제거되는 기능 추가
  - 선택할 때 마다 Label에 선택한 메뉴와 옵션이 표시되고, 취소할 때마다 해당 항목이 제거되는 기능 추가

# 느낀점
- CheckBox와 RadioButton, GroupBox를 활용하여 UI를 구성하는 방법을 배웠습니다.
- CheckBox와 RadioButton의 차이점과 사용법을 이해할 수 있었습니다.
- GroupBox를 사용하여 관련된 컨트롤들을 그룹화하는 방법을 배웠습니다.
